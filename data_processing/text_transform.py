...
#Load Dataset
# DOWNLOAD MODELS FROM https://mega.nz/#F!85QnHS5L!crJsvvXG57PTRJW7XNc_PA

dataset = pd.read_csv( 'semeval2018_test.csv',delimiter='\t')
tweets1 = dataset['sentence']
...
google_300 = gensim.models.KeyedVectors.load_word2vec_format( "../word2vec/embeddings/glove_word2vec.txt" , binary=False )
...
for line in tok:
    ...
    for token in line:
        ...
        # #token = token.lower()
        # if token == "<mention>":
        #     gen_vec = generics_500.wv[ "mention" ]
        #     is_in_model = True
        # elif token == "<url>":
        #     is_in_model = True
        #     gen_vec = generics_500.wv[ "url" ]
        # elif token == "<reserved>":
        #     is_in_model = True
        #     gen_vec = generics_500.wv[ "reserved" ]
        # elif token == "<number>":
        #     is_in_model = True
        #     gen_vec = generics_500.wv[ "number" ]
        # elif token == "<percent>":
        #     is_in_model = True
        #     gen_vec = generics_500.wv[ "percent" ]
        # elif token == "<money>":
        #     is_in_model = True
        #     gen_vec = generics_500.wv[ "money" ]
        # elif token == "<email>":
        #     is_in_model = True
        #     gen_vec = generics_500.wv[ "email" ]
        # elif token == "<phone>":
        #     is_in_model = True
        #     gen_vec = generics_500.wv[ "phone" ]
        # elif token == "<time>":
        #     is_in_model = True
        #     gen_vec = generics_500.wv[ "time" ]
        # elif token == "<date>":
        #     is_in_model = True
        #     gen_vec = generics_500.wv[ "date" ]
        #
        # elif token in generics_500.wv.vocab.keys ( ):
        #      is_in_model = True
        #      gen_vec = generics_500.wv[ token ]
        #
        # elif not is_in_model:
        #     max = len ( generics_500.wv.vocab.keys ( ) ) - 1
        #     index = rn.randint ( 0 , max )
        #     word = generics_500.index2word[ index ]
        #     gen_vec = generics_500.wv[ word ]
        ...
        # #token = token.lower()
        # if token == "<mention>":
        #     senti_p_vec = senti_pos_500.wv[ "mention" ]
        #     is_in_model = True
        # elif token == "<url>":
        #     is_in_model = True
        #     senti_p_vec = senti_pos_500.wv[ "url" ]
        # elif token == "<reserved>":
        #     is_in_model = True
        #     senti_p_vec = senti_pos_500.wv[ "reserved" ]
        # elif token == "<number>":
        #     is_in_model = True
        #     senti_p_vec = senti_pos_500.wv[ "number" ]
        # elif token == "<percent>":
        #     is_in_model = True
        #     senti_p_vec = senti_pos_500.wv[ "percent" ]
        # elif token == "<money>":
        #     is_in_model = True
        #     senti_p_vec = senti_pos_500.wv[ "money" ]
        # elif token == "<email>":
        #     is_in_model = True
        #     senti_p_vec = senti_pos_500.wv[ "email" ]
        # elif token == "<phone>":
        #     is_in_model = True
        #     senti_p_vec = senti_pos_500.wv[ "phone" ]
        # elif token == "<time>":
        #     is_in_model = True
        #     senti_p_vec = senti_pos_500.wv[ "time" ]
        # elif token == "<date>":
        #     is_in_model = True
        #     senti_p_vec = senti_pos_500.wv[ "date" ]
        #
        # elif token in senti_pos_500.wv.vocab.keys ( ):
        #      is_in_model = True
        #      senti_p_vec = senti_pos_500.wv[ token ]
        #
        # elif not is_in_model:
        #     max = len ( senti_pos_500.wv.vocab.keys ( ) ) - 1
        #     index = rn.randint ( 0 , max )
        #     word = senti_pos_500.index2word[ index ]
        #     senti_p_vec = senti_pos_500.wv[ word ]
        #
        # #Take from Embeddings
        # senti_n_vec =[]
        # is_in_model = False
        # #token = token.lower()
        # if token == "<mention>":
        #     senti_n_vec = senti_neg_500.wv[ "mention" ]
        #     is_in_model = True
        # elif token == "<url>":
        #     is_in_model = True
        #     senti_n_vec = senti_neg_500.wv[ "url" ]
        # elif token == "<reserved>":
        #     is_in_model = True
        #     senti_n_vec = senti_neg_500.wv[ "reserved" ]
        # elif token == "<number>":
        #     is_in_model = True
        #     senti_n_vec = senti_neg_500.wv[ "number" ]
        # elif token == "<percent>":
        #     is_in_model = True
        #     senti_n_vec = senti_neg_500.wv[ "percent" ]
        # elif token == "<money>":
        #     is_in_model = True
        #     senti_n_vec = senti_neg_500.wv[ "money" ]
        # elif token == "<email>":
        #     is_in_model = True
        #     senti_n_vec = senti_neg_500.wv[ "email" ]
        # elif token == "<phone>":
        #     is_in_model = True
        #     senti_n_vec = senti_neg_500.wv[ "phone" ]
        # elif token == "<time>":
        #     is_in_model = True
        #     senti_n_vec = senti_neg_500.wv[ "time" ]
        # elif token == "<date>":
        #     is_in_model = True
        #     senti_n_vec = senti_neg_500.wv[ "date" ]
        #
        # elif token in senti_neg_500.wv.vocab.keys ( ):
        #      is_in_model = True
        #      senti_n_vec = senti_neg_500.wv[ token ]
        #
        # elif not is_in_model:
        #     max = len ( senti_neg_500.wv.vocab.keys ( ) ) - 1
        #     index = rn.randint ( 0 , max )
        #     word = senti_neg_500.index2word[ index ]
        #     senti_n_vec = senti_neg_500.wv[ word ]
...
joblib.dump(matrix3D, 'matrix3D_SEM2018_test_glove')
