...
training3D_matrix = joblib.load('../data_processing/matrix3D_EMOCONT_train_fasttext')
print(training3D_matrix.shape)
#Load Training Matrix
test3D_matrix = joblib.load('../data_processing/matrix3D_EMOCONT_test_fasttext')

dataset = pd.read_csv( '../data_processing/train_emocontext.csv',delimiter='\t')
t1 = dataset['label']
...
filepath="weights.{epoch:02d}-{val_loss:.2f}_fasttext_emoC.hdf5"
