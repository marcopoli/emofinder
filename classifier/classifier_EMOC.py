...
training3D_matrix = joblib.load('../data_processing/matrix2D_EMOCONT_train_fasttext_flatten')
print(training3D_matrix.shape)
#Load Training Matrix
test3D_matrix = joblib.load('../data_processing/matrix2D_EMOCONT_test_fasttext_flatten')
...
gnb = GaussianNB()#SVC(kernel='rbf',gamma=0.2, C=1.5)# RandomForestClassifier(n_estimators=500)# SVC(kernel='rbf',gamma=0.2, C=1.5) #GaussianNB()
...
pre = precision_score ( y_pred , test_classes , average='micro', labels=['happy','angry','sad'])
print ( " Pre:" , pre )

re = recall_score ( y_pred , test_classes , average='micro', labels=['happy','angry','sad'])
print ( " Rec:" , re )

f1 = f1_score ( y_pred , test_classes , average='micro' , labels=['happy','angry','sad'])
print ( " F1:" , f1 )
